...
Most QA projects focus only on testing.

This project simulates the **entire product lifecycle**, including:
- Product thinking via user stories
- Sprint-based execution
- Structured QA + defect tracking
- Business-level UAT validation

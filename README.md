...
##  Objectives
1. Simulate a FinTech product lifecycle  
2. Apply QA + UAT best practices
3. Understand release management workflows
4. Build a product + QA hybrid mindset  
...
│
├── jira/
│   └── user-stories.md (or screenshots)
